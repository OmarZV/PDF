...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post charges_url, params: { charge: { Amount: @charge.Amount, Card_last4: @charge.Card_last4, Card_type: @charge.Card_type, Product: @charge.Product, user_id: @charge.user_id } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { Amount: @charge.Amount, Card_last4: @charge.Card_last4, Card_type: @charge.Card_type, Product: @charge.Product, user_id: @charge.user_id } }
